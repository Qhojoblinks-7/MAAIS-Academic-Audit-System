      ...
      <div className="max-w-full">
        <header className="mb-10 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <button className="px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-gray-50 transition-all flex items-center gap-2"><Calendar size={14} /> Semester 2</button>
