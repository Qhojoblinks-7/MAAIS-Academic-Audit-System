    ...
    <div className={cn("p-6 text-primary-foreground shrink-0 relative overflow-hidden transition-colors duration-500", headerBg)}>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 relative">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button onClick={() => setActiveTab('assignments')} className={cn("text-[9px] font-black uppercase tracking-widest transition-all px-3 py-1.5 rounded-lg cursor-pointer", activeTab === 'assignments' ? "text-primary-foreground bg-primary-foreground/15" : "text-primary-foreground/60 hover:text-primary-foreground bg-primary-foreground/5 hover:bg-primary-foreground/10")}>Assignments</button>
          <button onClick={() => setActiveTab('subjects')} className={cn("text-[9px] font-black uppercase tracking-widest transition-all px-3 py-1.5 rounded-lg cursor-pointer", activeTab === 'subjects' ? "text-primary-foreground bg-primary-foreground/15" : "text-primary-foreground/60 hover:text-primary-foreground bg-primary-foreground/5 hover:bg-primary-foreground/10")}>Subjects</button>
