       ...
       {students.map((student, idx) => {
         ...
         return (
           ...
           >
             ...
             <td className="px-4 py-3.5 text-[10px] font-semibold text-text-secondary border-r border-slate-100">
             ...
             {/* Student Name Column */}
             <td className="px-4 py-3.5 text-[11px] font-medium text-text-primary border-r border-slate-100">
               {student.name}
             </td>
             ...
             {isExamExpanded && (
               <>
                 {sectionFieldNames.map((fieldName) => {
                   ...
                   return (
                     <td key={fieldName} className="px-4 py-2 border-r border-slate-100 text-center bg-slate-50/30 w-24">
                       <input 
                         type="number" 
                 ...
                 <td className="px-4 py-3.5 text-[11px] font-bold text-text-primary border-r border-slate-100 text-center bg-slate-100/40 w-24">
                   {rowTotal}
                 </td>
               </>
             )}
             ...
             <td className="px-4 py-3.5 text-[11px] font-bold text-text-primary border-r border-slate-100 text-center w-20 bg-slate-50/20">
               {student.final}
             </td>
             
             <td className="px-4 py-3.5 text-[11px] font-bold text-success border-r border-slate-100 text-center w-20 bg-success/10">
               {student.grade}
             </td>
