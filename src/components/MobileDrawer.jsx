...
export function MobileDrawer() {
  ...
  const navItems = [
    ...
    { icon: Database as any, label: 'Extended Logs', id: 'audit-ext', path: '/audit/extended', roles: ['ADMIN'] },
    { icon: AlertCircle as any, label: 'Academic Audit', id: 'audit', path: '/audit', roles: ['HOD', 'ADMIN'] },
